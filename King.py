        ...
        if self.color == "white":
            if self.has_not_moved:
                ...
                if board[0][0].piece and board[0][0].piece.name == "Rook" and board[0][0].piece.has_not_moved:
                    ...
                    if not board[1][0].piece and not board[2][0].piece:
                        possible_castling.append([(1, 0), (3, 0), (2, 0), (0, 0)]) # king new, king old, rook new, rook old
                # long castles
                # king and rook have not moved
                if board[7][0].piece and board[7][0].piece.name == "Rook" and board[7][0].piece.has_not_moved:
                    # no pieces in between
                    if not board[4][0].piece and not board[5][0].piece and not board[6][0].piece:
                        possible_castling.append([(5, 0), (3, 0), (4, 0), (7, 0)]) # king new, king old, rook new, rook old
        ...
        if self.color == "black":
            if self.has_not_moved:
                ...
                if board[0][7].piece and board[0][7].piece.name == "Rook" and board[0][7].piece.has_not_moved:
                    # no pieces in between
                    if not board[1][7].piece and not board[2][7].piece:
                        possible_castling.append([(1, 7), (3, 7), (2, 7), (0, 7)]) # king new, king old, rook new, rook old

                # long castles
                # king and rook have not moved
                if board[7][7].piece and board[7][7].piece.name == "Rook" and board[7][7].piece.has_not_moved:
                    # no pieces in between
                    if not board[4][7].piece and not board[5][7].piece and not board[6][7].piece:
                        possible_castling.append([(5, 7), (3, 7), (4, 7), (7, 7)]) # king new, king old, rook new, rook old
